<%@page import="tw.pony.apis.Member"%>
<%@ page language="java" contentType="text/html; charset=UTF-8"
    pageEncoding="UTF-8"%>
  <%
  Member member1 = new Member();
  member1.setId(1);member1.setAccount("pony");member1.setCname("Pony");
  %>
  <jsp:useBean id="member2" class="tw.pony.apis.Member"></jsp:useBean>
